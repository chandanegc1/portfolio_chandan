...
const Loader = ({loading}) => {
  ...
  return (
    <>{!hideLoader?<div
      className="w-full h-full bg-black fixed z-50 transition-all duration-500 ease-linear top-0 text-white text-3xl font-extrabold uppercase flex justify-center place-items-center"
      id="loader"
      style={loaderStyle}
    >
